...
var CreateVMActions = (function () {
    function CreateVMActions() {
        _classCallCheck(this, CreateVMActions);
    ...
    _createClass(CreateVMActions, [{
        key: 'createVM',
        value: function createVM(image, flavour) {
            var _this = this;
            ...
            $.ajax({
                ...
                _this.actions.createVMSuccess(data.message);
            }).fail(function (jqXhr) {
                _this.actions.createVMFail(jqXhr.responseJSON.message);
            });
        }
    }, {
        key: 'getImages',
        value: function getImages() {
            ...
            $.ajax({
                ...
                _this2.actions.getImagesSuccess(data);
            }).fail(function (jqXhr) {
                _this2.actions.getImagesFail(jqXhr.responseJSON.message);
            });
        }
    }, {
        key: 'getFlavors',
        value: function getFlavors() {
            var _this3 = this;
            ...
            $.ajax({
                ...
                _this3.actions.getFlavorsSuccess(data);
            }).fail(function (jqXhr) {
                _this3.actions.getFlavorsFail(jqXhr.responseJSON.message);
            });
        }
    }]);

    return CreateVMActions;
})();
...
var LoginActions = (function () {
    function LoginActions() {
        ...
        this.generateActions('loginSuccess', 'loginFail', 'updateUsername', 'updatePassword');
    }
    ...
    _createClass(LoginActions, [{
        ...
        value: function postLogin(username, password) {
            ...
            $.ajax({
                ...
                _this.actions.loginFail(errorMessage);
            });
        }
    }]);
...
var SignUpActions = (function () {
    function SignUpActions() {
        ...
        this.generateActions('signUpSuccess', 'signUpFail', 'updateUsername', 'updatePassword');
    }
    ...
    _createClass(SignUpActions, [{
        ...
        value: function userSignUp(username, password) {
            ...
            $.ajax({
                ...
                _this.actions.signUpSuccess(data);
            }).fail(function (jqXhr) {
...
var _storesCreateVMStore = require('../stores/CreateVMStore');

var _storesCreateVMStore2 = _interopRequireDefault(_storesCreateVMStore);

var _actionsCreateVMActions = require('../actions/CreateVMActions');

var _actionsCreateVMActions2 = _interopRequireDefault(_actionsCreateVMActions);
...
var CreateVM = (function (_React$Component) {
    ...
    function CreateVM(props) {
        ...
        _get(Object.getPrototypeOf(CreateVM.prototype), 'constructor', this).call(this, props);
        this.state = _storesCreateVMStore2['default'].getState();
    ...
    _createClass(CreateVM, [{
        ...
        value: function componentDidMount() {
            _storesCreateVMStore2['default'].listen(this.onChange);
            _actionsCreateVMActions2['default'].getFlavors();
            _actionsCreateVMActions2['default'].getImages();
        }
    }, {
        key: 'componentWillUnmount',
        value: function componentWillUnmount() {
            _storesCreateVMStore2['default'].unlisten(this.onChange);
        }
    }, {
        key: 'onChange',
        ...
        value: function handleSubmit(event) {
            ...
            if (!image) {
                _actionsCreateVMActions2['default'].invalidImage();
            }
            if (!flavor) {
                _actionsCreateVMActions2['default'].invalidFlavor();
            }
            if (image) {
                _actionsCreateVMActions2['default'].createVM();
            }
        }
    }, {
        key: 'renderImageLists',
        value: function renderImageLists() {
            return this.state.imageList.map(function (image, index) {
                return React.createElement(
                    'div',
                    null,
                    React.createElement(
        ...
        key: 'renderFlavoursList',
        value: function renderFlavoursList() {
            return this.state.flavorList.map(function (flavour, index) {
                return React.createElement(
                    'div',
                    null,
                    React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                Button,
                                { bsStyle: 'primary', id: 'werewr', name: 'werwer' },
                                'dasd'
                            )
                        ),
                        React.createElement(
...
var _componentsCreateVM = require('./components/CreateVM');

var _componentsCreateVM2 = _interopRequireDefault(_componentsCreateVM);
...
var CreateVMStore = (function () {
    function CreateVMStore() {
        _classCallCheck(this, CreateVMStore);

        this.bindActions(_actionsCreateVMActions2['default']);
        this.images = '';
        this.flavor = '';
        this.imageList = [];
        this.flavorList = [];
    ...
    _createClass(CreateVMStore, [{
        key: 'onCreateVMSuccess',
        value: function onCreateVMSuccess(successMessage) {}
    }, {
        key: 'onCreateVMFail',
        value: function onCreateVMFail(errorMessage) {}
    }, {
        key: 'onGetImagesSuccess',
        value: function onGetImagesSuccess(data) {
            this.imageList = data;
        }
    }, {
        key: 'onGetImagesFail',
        value: function onGetImagesFail(errorMessage) {
            console.log(' On Get images ' + errorMessage);
        }
    }, {
        key: 'onGetFlavorsSuccess',
        value: function onGetFlavorsSuccess(data) {
            this.flavorList = data;
        }
    }, {
        key: 'onGetFlavorsFail',
        value: function onGetFlavorsFail(errorMessage) {
